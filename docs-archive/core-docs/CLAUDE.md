...
This is a FastAPI-based Whisper transcription service that provides GPU-accelerated speech-to-text capabilities with optional speaker diarization. The service exposes REST API endpoints for both synchronous and asynchronous audio transcription. NVER USE CPU for whisper or for diarization.
